function SFCPTM(sfcdata,DataSet,freqrange,ch_s,sorts,ch_w)
% SFCPTM.m
% 2011-03-26 by Zhang Li
% Draw Spike Field Coherence Phase Tuning Map

if nargin < 3
    prompt = {'Start Frequency :','Stop Frequency :'};
    dlg_title = 'Spike Field Coherence Tuning Map';
    num_lines = 1;
    def = {'0','200'};
...
fig_name = [DataSet.Mark.extype,'__',DataSet.Snip.spevent,...
    '__( C-',num2str(ch_s),'_U-',sorts,' ^ C-',num2str(ch_w),' )__SFCPTM_',sfctype];
