% VisualizeResult_sISI.m %

disp('  Visualizing Result_sISI ...');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
while (nStimuli~=0)
    ...
    if (show_id=='p')
        ...
        % new figure for plot
        Describe_All=['( ',BlockName_Snip,' )','_SC_A_nS_',show_id,'_sISI'];
        Describe_Sort=['( ',BlockName_Snip,' )','_SC_',int2str(z),'_nS_',show_id,'_sISI'];
        ...
        ylabel([int2str(ISI_count(1,str2double(show_id))),' sISIs ','in ',int2str(nTrial),' Trials']);
        xlabel('Time [ms]');
        hCurrentAxes=gca;
