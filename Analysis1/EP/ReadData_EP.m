...
DataName_mark=input('Input the Data File Name for Marker : ','s');
DataName_spike=input('Input the Data File Name for Spike : ','s');

disp('  Reading Data ... ');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
DataMark=csvread(['_',DataName_mark,'_mark.csv'],1,3);  % Stimulus Marker with full tags
marker=DataMark(:,1)';
clear DataName_mark;
clear DataMark;
%-----------------------------------------------------------
DataSnip=csvread(['_',DataName_spike,'_os.csv'],1,3);      % Spike Snip with full tags
