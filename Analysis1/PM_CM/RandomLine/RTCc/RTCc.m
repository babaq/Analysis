...
% RTCc Function for analysis of time course of pattern motion and component motion
...
ResultDir=[BlockName_Snip,'_RTCc'];
mkdir(ResultDir);      % Directory for saving the time course results
cd(deblank(ResultDir));

Bin=0.05;            % Bin Time to analysis time course of RandomLine
...
for z=1:Max_Sort
        ...
        for Bn=1:Bin_number
    ProcessSpike_RTCc;
    VisualizeResult_RTCc_TuningCurve;
    VisualizeResult_RTCc_Polar;
        end
end
end
