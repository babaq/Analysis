% 2007 April 11 by Zhang Li
% Add this directory in the matlab path
% DataDir is the Directory in which you stored the Data Files

% RandomLine Function for analysis of pattern motion and component motion
...
for z=-1:Max_Sort
    ...
    ProcessSpike_RandomLine;  % For spikes with no sorting(z=-1) and each SortCode(z>-1)
    VisualizeResult_RandomLine_TuningCurve;
    VisualizeResult_RandomLine_Polar;
end
end
